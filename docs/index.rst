...
================================
GAZE is a comprehensive tool to integrate multi-modal high throughput data with single-cell RNA-seq measurements to build a statistical model that is able to infer transcription factor (TF) binding activity at single cell resolution.
